document.addEventListener('DOMContentLoaded', function () {
    function stylizeVowelsInTextNode(textNode) {
        ...
        const vowelRegex = /(?<=\w)([aeoiuyAEIOUY])(?=\w)/g;
    ...
    function processNode(node) {
        if (node.nodeType === Node.TEXT_NODE) {
            ...
            if (styledFragment.childNodes.length > 0 && (styledFragment.childNodes.length > 1 || styledFragment.firstChild.nodeType !== Node.TEXT_NODE || styledFragment.firstChild.nodeValue !== node.nodeValue)) {
